...
export const kanbanConsoleMessages = {
  en: {
    ...
    agentWorkflowDeploy: "Deploy readiness",
    agentWorkflowEnvAudit: "Environment audit",
    agentWorkflowExecuteTask: "Execute task",
    agentWorkflowExtractPrLearnings: "Extract PR learnings",
    agentWorkflowIfrsAudit: "IFRS audit",
    agentWorkflowInitProject: "Initialize project",
    agentWorkflowOpenPr: "Open PR",
    agentWorkflowOrchestrate: "Orchestrate next step",
    agentWorkflowPdplAudit: "PDPL audit",
    agentWorkflowPhase: "Implement phase",
    agentWorkflowPlan: "Plan work",
    agentWorkflowPlanStatus: "Plan status",
    agentWorkflowPreflight: "Preflight",
    agentWorkflowReview: "Review",
    agentWorkflowSecurityAudit: "Security audit",
    agentWorkflowSetupRequired: "setup required",
    agentWorkflowShip: "Ship readiness",
    agentWorkflowUat: "Draft UAT",
    agentWorkflowUnknown: "Unknown workflow",
    agentWorkflowUpgradeMultitenant: "Upgrade multitenant",
    agentWorkflowUserStories: "Draft user stories",
  ...
  ar: {
    ...
    agentWorkflowDeploy: "جاهزية النشر",
    agentWorkflowEnvAudit: "تدقيق البيئة",
    agentWorkflowExecuteTask: "تنفيذ المهمة",
    agentWorkflowExtractPrLearnings: "استخراج دروس طلب السحب",
    agentWorkflowIfrsAudit: "تدقيق IFRS",
    agentWorkflowInitProject: "تهيئة المشروع",
    agentWorkflowOpenPr: "فتح طلب سحب",
    agentWorkflowOrchestrate: "تنسيق الخطوة التالية",
    agentWorkflowPdplAudit: "تدقيق PDPL",
    agentWorkflowPhase: "تنفيذ المرحلة",
    agentWorkflowPlan: "تخطيط العمل",
    agentWorkflowPlanStatus: "حالة الخطة",
    agentWorkflowPreflight: "فحص تمهيدي",
    agentWorkflowReview: "مراجعة",
    agentWorkflowSecurityAudit: "تدقيق الأمان",
    agentWorkflowSetupRequired: "يتطلب إعدادا",
    agentWorkflowShip: "جاهزية الشحن",
    agentWorkflowUat: "إعداد UAT",
    agentWorkflowUnknown: "سير عمل غير معروف",
    agentWorkflowUpgradeMultitenant: "ترقية تعدد المستأجرين",
    agentWorkflowUserStories: "صياغة قصص المستخدم",
...
export const agentWorkflowLabelKeys = {
  deploy: "agentWorkflowDeploy",
  "env-audit": "agentWorkflowEnvAudit",
  "execute-task": "agentWorkflowExecuteTask",
  "extract-pr-learnings": "agentWorkflowExtractPrLearnings",
  "ifrs-audit": "agentWorkflowIfrsAudit",
  "init-project": "agentWorkflowInitProject",
  "open-pr": "agentWorkflowOpenPr",
  orchestrate: "agentWorkflowOrchestrate",
  "pdpl-audit": "agentWorkflowPdplAudit",
  phase: "agentWorkflowPhase",
  plan: "agentWorkflowPlan",
  "plan-status": "agentWorkflowPlanStatus",
  preflight: "agentWorkflowPreflight",
  review: "agentWorkflowReview",
  "security-audit": "agentWorkflowSecurityAudit",
  ship: "agentWorkflowShip",
  uat: "agentWorkflowUat",
  "upgrade-multitenant": "agentWorkflowUpgradeMultitenant",
  "user-stories": "agentWorkflowUserStories",
} as const satisfies Record<
  KanbanConsoleAgentWorkflowCommandId,
  keyof typeof kanbanConsoleMessages.en
>;

const agentWorkflowCommands: Record<KanbanConsoleAgentWorkflowCommandId, string> = {
  deploy: "/deploy web local --prepare-only",
  "env-audit": "/env-audit",
  "execute-task": "/execute-task 43",
  "extract-pr-learnings": "/extract-pr-learnings 29",
  "ifrs-audit": "/ifrs-audit",
  "init-project": "/init-project",
  "open-pr": "/open-pr feat phase-2-command-launcher-parity",
  orchestrate: "/orchestrate t3-kanban-command-uat-deploy",
  "pdpl-audit": "/pdpl-audit",
  phase: "/phase t3-kanban-command-uat-deploy phase-2",
  plan: '/plan t3-kanban-command-uat-deploy "Command UAT and deploy workflow support"',
  "plan-status": "/plan-status t3-kanban-command-uat-deploy",
  preflight: "/preflight",
  review: "/review",
  "security-audit": "/security-audit",
  ship: "/ship t3-kanban-command-uat-deploy",
  uat: "/uat t3-kanban-command-uat-deploy --atlas",
  "upgrade-multitenant": "/upgrade-multitenant",
  "user-stories": '/user-stories t3-kanban-command-uat-deploy "Command parity for UAT and deploy"',
};

export const agentWorkflowCommandIds = Object.keys(
  agentWorkflowCommands,
) as KanbanConsoleAgentWorkflowCommandId[];

const setupRequiredCommands = new Set<KanbanConsoleAgentWorkflowCommandId>([
  "deploy",
  "ifrs-audit",
  "review",
  "security-audit",
...
const agentWorkflows: KanbanConsoleAgentWorkflow[] = agentWorkflowCommandIds.map(
  (commandId, index) => ({
    id: `workflow-${commandId}`,
    label: kanbanConsoleMessages.en[agentWorkflowLabelKeys[commandId]],
    agent: index % 2 === 0 ? "Codex" : "Claude",
    command: agentWorkflowCommands[commandId],
    commandId,
    available: !setupRequiredCommands.has(commandId),
  }),
);
